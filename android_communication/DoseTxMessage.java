...
public class DoseTxMessage {
    ...
    public DoseTxMessage(float insulinDose, float symlinDose, float glucagonDose, byte verificationId, boolean unsafe) {

        this(insulinDose, symlinDose, glucagonDose, verificationId, unsafe, -1, false, false, 0, 0);
    }

    public DoseTxMessage(float insulinDose, float symlinDose, float glucagonDose, byte verificationId, boolean unsafe, int basalIndex, boolean tempBasalActive, boolean tempBasalIsPercent, float tempBasal, long tempDurationMillis) {
        ...
        byteBuffer.putChar(tempDurationMillis == Long.MAX_VALUE ? (char)0xFF : (char) (tempDurationMillis / Millis.ONE_MINUTE));
